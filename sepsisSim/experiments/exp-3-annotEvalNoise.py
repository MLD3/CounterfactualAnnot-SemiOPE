...
parser.add_argument('--annot_noise', type=float)
...
out_fname = f'./results/{exp_name}/vaso_eps_{eps_str}-{pol_name}-aug_step-annotEval-Noise_{annot_noise}.csv'
